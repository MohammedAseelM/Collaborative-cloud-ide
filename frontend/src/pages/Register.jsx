...
// Responsibility: Registration form UI. Collects name/email/password, supports Google Sign-In,
// calls AuthContext.register / loginWithGoogle, and redirects to dashboard.
  ...
  const googleConfigured = useGoogleSignIn({
    ...
    onCredential: async (credential) => {
      ...
      try {
        ...
        addToast("Registered and logged in with Google successfully!", "success");
        navigate("/dashboard");
      } finally {
